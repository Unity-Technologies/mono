...
typedef void (*LateHandleCallback)(void* arg, uintptr_t handle);

typedef void (*OnThreadsSuspendedCallback)(void* arg);
typedef void (*OnHandleFoundCallback)(void* arg, void* handle);
typedef void (*OnProcessCallback)(void* arg, LateHandleCallback markHandleCallback, void* markHandleCallbackArg);
